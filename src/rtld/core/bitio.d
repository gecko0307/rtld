...
/**
 * Bit and byte-level manipulations
 *
 * Copyright: Timur Gafarov 2015-2026.
 * License: $(LINK2 https://boost.org/LICENSE_1_0.txt, Boost License 1.0).
 * Authors: Timur Gafarov
 */
module rtld.core.bitio;
 ...
 */
pragma(inline, true)
T hiNibble(T)(T b) pure nothrow @nogc
{
    return ((b >> 4) & 0x0F);
}
 ...
 */
pragma(inline, true)
T loNibble(T)(T b) pure nothrow @nogc
{
    return (b & 0x0F);
}
 ...
 */
pragma(inline, true)
T setBit(T)(T b, uint pos, bool state) pure nothrow @nogc
{
    if (state)
 ...
 */
pragma(inline, true)
bool getBit(T)(T b, uint pos) pure nothrow @nogc
{
    return ((b & (1 << pos)) != 0);
}
