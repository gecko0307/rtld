...
void init() nothrow @nogc
{
    ...
    rtld.random.pcg.init(seed64, seed32);
    rtld.random.ziggurat.init(seed32);
}

//
private uint random(uint bound) nothrow @nogc
{
 ...
 */
T choice(T)(T[] values...) nothrow @nogc
{
 ...
 */
uint rollDice(uint sides) nothrow @nogc
{
    assert(sides > 0);
